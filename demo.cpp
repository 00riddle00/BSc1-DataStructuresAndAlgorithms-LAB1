...
//    assert(strcmp(numToChar(res), "1.609437912434100374600759333226187639525601354268517721912647891474178987707657764630133878093179611") == 0 && "Sine test01 failed");
    ...
    printEntry(res);
//    setPrecision(res, 100);
//    assert(strcmp(numToChar(res), "0.91294525072762765437609998384568230129793258370818995630512811476884891934907297604448004964046997") == 0 && "Sine test01 failed");
    assert(strcmp(numToChar(res), "0.912945250727627654376099983845682301297932583708189956305128114768848919349072976044480049640469976228713881649041074809104275193662195819938913895612178340575473154953273229055976191660132707431490402800001100099999999999989999") == 0 && "Sine test01 failed");
