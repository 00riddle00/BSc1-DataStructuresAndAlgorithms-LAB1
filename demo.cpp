...
//    assert(strcmp(numToChar(num3), "1.3") == 0 && "modulusEquals test01 failed");
    ...
    /* live tests */
//    Number *num4 = setNumberFromChar((char *) "100.0");
//    res = factorial(num4);
...
//    debug("factorial passed");

    Number *num5 = setNumberFromChar((char *) "961748941.0");
    res = nextPrime(num5);
    debug("RES is");
    printEntry(res);
//    assert(strcmp(numToChar(res), "961749043.0") == 0 && "nextPrime test01 failed");
    debug("nextPrime passed");
//
//    Number *num6 = setNumberFromChar((char *) "213421342318412384912738132894712.8128374823174812377321");
//    res = raiseByPow(num6, 6);
