...
//    printf("...factorial test03 passed\n");
...
//    printf("...factorial test04 passed\n");
    // // test factorial
...
//    printf("...nextPrime test01 passed\n");
...
//    printf("...raiseByPow test01 passed\n");
